...
class HuffmanCoder{
    ...
    encode(data){
        ...
        info = "Compression completed successfully. File download process will begin soon." + '\n' + info;
    ...
    decode(data){
        ...
        let info = "Decompression completed successfully. File download process will begin soon.";
